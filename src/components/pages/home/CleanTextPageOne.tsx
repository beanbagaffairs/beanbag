export default function CleanTextPageOne() {
  return (
    <section
      ...
      className="h-auto min-h-[100vh] w-full bg-white text-gray-800 px-4 sm:px-8 md:px-16 lg:px-24 xl:px-40 py-16 sm:py-20 lg:py-28 flex flex-col items-start justify-between"
    >
      <div className="">
        <p className="w-full sm:w-[80vw] md:w-[70vw] lg:w-[60vw] xl:w-[50vw] text-[28px] sm:text-[36px] md:text-[42px] lg:text-[48px] xl:text-[50px] text-left mt-4 text-[#1C2042] font-bold font-formular tracking-tighter">
          What We Make,
        </p>
        <p className="w-full sm:w-[80vw] md:w-[70vw] lg:w-[60vw] xl:w-[50vw] text-[28px] sm:text-[36px] md:text-[42px] lg:text-[48px] xl:text-[50px] text-left -mt-2 sm:-mt-3 lg:-mt-4 text-[#1C2042] font-bold font-formular tracking-tighter">
      ...
      <div className="flex flex-col gap-2 mt-8 sm:mt-12 lg:mt-0">
        ...
        <p className="text-[#1C2042] font-formular tracking-tight text-[14px] sm:text-[15px] lg:text-[16px] max-w-xs sm:max-w-sm lg:max-w-md">
          From timeless frames to modern moods, we don<span className="font-sans">&apos;</span>t just capture how you

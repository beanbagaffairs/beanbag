...
const DownloadBrochureBanner = () => {
  return (
    <section className="w-full h-auto px-4 sm:px-8 md:px-16 lg:px-24 xl:px-40 py-12 sm:py-16 lg:py-20 flex items-center justify-center bg-white">
      <motion.div
        initial={{ opacity: 0, y: 40 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6, ease: "easeOut" }}
        viewport={{ once: true }}
        className="h-auto min-h-[30vh] sm:min-h-[35vh] lg:min-h-[40vh] w-full sm:w-[90vw] md:w-[80vw] lg:w-[70vw] rounded-2xl sm:rounded-3xl overflow-hidden bg-gradient-to-r from-[#FFE5EC] to-[#FDEAD9] flex flex-col sm:flex-row items-center justify-evenly md:justify-start px-6 sm:px-8 lg:px-12 py-6 sm:py-8 lg:py-6 shadow-md font-formular"
      >
